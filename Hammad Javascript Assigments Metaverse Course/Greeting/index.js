...
var names = ['Wali', 'Zeeshan', 'Arshad',];

console.log(names[0],"is my office collegue.");
console.log(names[1],"is my office collegue.");
console.log(names[2],"is my office collegue.");
